...
def backup():
    try:
        ...
        process.wait()
        return jsonify({'success': process.returncode == 0, 'file': str(backup_file), 'output': '\n'.join(output)})
    except Exception as e:
